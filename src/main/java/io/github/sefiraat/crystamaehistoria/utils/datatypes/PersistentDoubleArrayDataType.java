...
public class PersistentDoubleArrayDataType implements PersistentDataType<byte[], double[]> {

    public static final PersistentDoubleArrayDataType TYPE = new PersistentDoubleArrayDataType();
